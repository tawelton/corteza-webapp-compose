<template>
  <b-tab :title="$t('block.recordLines.label')">
    ...
    >
      ...
      <b-form-group horizontal :label-cols="3" breakpoint="md" :label="$t('block.recordLines.parentField.label')">
        <b-form-select v-model="options.parentField" required>
        ...
        <b-form-text class="text-secondary small">{{ $t('block.recordLines.parentField.footnote') }}</b-form-text>
      </b-form-group>

      <b-form-group horizontal :label-cols="3" breakpoint="md" :label="$t('block.recordLines.positionField.label')">
        ...
        <b-form-text class="text-secondary small">{{ $t('block.recordLines.positionField.footnote') }}</b-form-text>
      </b-form-group>
